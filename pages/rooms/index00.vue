...
// 使用 useAssets 來解析路徑
// 引入所有符合模式的圖片
const images = import.meta.glob("@/assets/images/room-*.png");
const rooms = "a";
const numList = "1";
console.log(images[`/assets/images/room-${rooms}-${numList}.png`]);
...
//         desktop: `../../assets/images/room-${roomId}-${num}.png`,
//         mobile: `../../assets/images/room-${roomId}-sm-${num}.png`,
//       };
//       return obj;
//     }, {});
                    ...
                    <swiper-slide>
                      <picture>
                        <source
                          :srcset="
                            images[
                              `/assets/images/room-${rooms}-${numList}.png`
                            ]
                          "
                        ...
                        <img
                          ...
                          :src="
                            images[
                              `/assets/images/room-${rooms}-sm-${numList}.png`
                            ]
                          "
                          loading="lazy"
                          :alt="`room-a-${numList}`"
            ...
            <li class="card flex-lg-row border-0 rounded-3xl overflow-hidden">
              <div class="row">
                <div class="col-12 col-lg-7">
                  ...
                  >
                    <swiper-slide v-for="(num, index) in nums" :key="index">
                      <picture>
                        <source
